    ...
    <div className="div_father_pedidos">
      ...
      {!isCarritoVisible && (
        <button className="carrito_icon_button" onClick={toggleCarrito}>
          <span className="carrito_icon">
            <img src={IMAGENES.carritoIco} alt="carrito" />
          </span>
            ...
            <div key={plato.idPlato} className="plato_card">
              <div className="plato_info">
                <div className="img_container">
                  <img src={rutaImagen} alt={plato.nombre} />
                  <button
                    className="btn_add_overlay"
                ...
                <div className="div_content_button"></div>
              </div>
            </div>
          );
        })}
